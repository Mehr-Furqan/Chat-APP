            ...
            <ScrollView style={{ marginTop: Platform.OS === 'ios' ? '10%' : null }}>
                ...
                <View style={{ justifyContent: 'space-between', flexDirection: 'row', marginTop: '3%', paddingHorizontal: '5%' }}>
                    ...
                    <View style={styles.nameContainer}>
                        ...
                        <Text style={styles.GroupParticipent}>Group Participents 10</Text>
                    </View>
                    <View style={{ flex: 1 }}>
                ...
                <View>
                    <FlatList
                        ...
                        renderItem={({ item, index }) => {
                            ...
                            return (
                                <View style={{ flexDirection: 'row', paddingHorizontal: '5%', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: Colors.lighGrayBorder, paddingVertical: '4%' }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        <Image style={styles.FlatListImg} source={item.img} />
                                        <Text style={styles.FlatListName}>{item.Name}</Text>
                                    </View >

                                    <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', alignSelf: 'center', flex: 1 }}><Image style={styles.more} source={assets.more} /></TouchableOpacity>
                ...
                <View >
                    <TouchableOpacity style={{ flexDirection: "row", backgroundColor: Colors.lighGrayBorder, alignContent: 'center', alignItems: 'center', paddingHorizontal: '5%', paddingVertical: '3%' }} >
                        <Image style={styles.AddNewwIcon} source={assets.addNew} />
                        <Text style={styles.AddNewText}>Add New Member</Text>
                    </TouchableOpacity>
                </View>
                <View>
                ...
                <View style={{ marginBottom: '50%' }}>
                    <TouchableOpacity style={[styles.LastTouchAble, { borderBottomWidth: 1, }]}>
                        ...
                        <Text style={styles.lastText}>Report Group</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.LastTouchAble}>
                        <Image style={styles.LastIcon} source={assets.LeaveGrouo} />
                        <Text style={styles.lastText}> Leave Group</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </SafeAreaView >
